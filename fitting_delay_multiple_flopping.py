...
#from os import sys
from rabiflop_fit_multiple import rabiflop,rabiflopfit
...
def fitting(dur, prob, weight):
    ...
    def resid(a, dur, prob, weight):
        return  np.sqrt(weight)*( prob - rabiflopfit(a[0], a[1], dur) )
    ...
    return n_avg_o, pi_pulse_o, n_avg_unc, pi_pulse_unc
#................................................................................................................
...
for i in range(len(delay)):
    ...
    n_avg[i], pi_pulse[i], n_avg_unc[i], pi_pulse_unc[i] = fitting(dur_nan, prob, weight_prob) 
    t, c12, error = rabiflop(n_avg[i], pi_pulse[i], points_per_flop, maxflops )
