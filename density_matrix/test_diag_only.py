...
#    for j in range(2*N):
#        if i == j + N:
#            hamil[i,j] = hbar*Omega_n[j]
#        elif i == j - N:
#            hamil[i,j] = hbar*Omega_n[i]
...
# Call the ODE solver
psoln = solve_ivp( lambda t,y: rho_changerate(t, y, hamiltonian=hamil, N=N, n=n, n_avg0=n_avg0, heating_rate=heating_rate ), (t0, tf), rho_kj.flatten(), method='RK45', rtol=1e-10, atol=1e-10 )
